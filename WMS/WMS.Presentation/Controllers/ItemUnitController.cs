...
namespace WMS.Presentation.Controllers
{
    ...
    public class ItemUnitController : ControllerBase
    {
        ...
        public ItemUnitController(IItemUnitService itemUnitService, IStringLocalizer<SharedResource> localizer, IMapper mapper)
        {
        ...
        public async Task<IActionResult> Add(ItemUnitDto itemUnitDto)
        {
            ...
            bool IsExist = await _itemUnitService.IsExistCombination(itemUnit.ItemID, itemUnit.UnitID);

            if (IsExist)
                return BadRequest(ApiResponse<object>.FailureResponse(
                    message: _localizer["ItemUnit_Already_Exist"],
